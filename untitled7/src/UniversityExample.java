...
public class UniversityExample {
    ...
    public static void main(String[] args) {
        ...
        List<Student> graduatedStudents = students.stream()
                .filter((Student student) -> examPassedNames.contains(student.surname)&&examPassedNames.contains(student.name)/* проверка, что студент успешно сдал экзамен */)
                .map((Student student) -> {student.groupName = groupNames.get(student.entranceYear);
                ...
                .peek((Student student) -> graduatesClub.add(student.email))/* добавление студента в клуб выпускников */
